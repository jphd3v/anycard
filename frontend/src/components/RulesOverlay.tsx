...
export function RulesOverlay({ rulesId, onClose }: Props) {
  ...
  return (
    ...
    >
      <div
        className="rules-modal relative w-full h-full bg-surface-1 rounded-none shadow-floating flex flex-col overflow-hidden animate-in fade-in zoom-in-95 duration-200 lg:rounded-2xl lg:h-auto lg:max-h-[820px] lg:max-w-[1280px]"
        role="dialog"
        aria-modal="true"
